...
public class GUI extends javax.swing.JFrame {
    /**
     * Mohee Qwareeq      11821353
     * Qotayba Darawshi   11925851
     */
    ...
    boolean S=false;
    boolean E=false;
    public static Stack <int [][]> testedNode= new Stack<int [][]>();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/retro-neon-color-game-controller-vector-33752714.jpg"))); // NOI18N
        Cover.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 850, 600));

        jLabel3.setText("jLabel3");
        Cover.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 373, -1, 100));
        ...
        jSlider2.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(222, 37, 38)));
        jPanel1.add(jSlider2);
        jSlider2.setBounds(0, 0, 200, 31);

        Cover1.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 450, 200, 30));

        frame.setIcon(new javax.swing.ImageIcon(getClass().getResource("/1 copy 2.png"))); // NOI18N
        Cover1.add(frame, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 90, 450, 490));

        icon8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/8.png"))); // NOI18N
        ...
        Start_and_end_points.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons8-job.png"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Red-direction-arrow-on-transparent-background-PNG.png"))); // NOI18N
        ...
        frame1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/1 copy 2.png"))); // NOI18N
        Cover2.add(frame1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 30, 450, 490));

        icon9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/8.png"))); // NOI18N
        ...
        Next.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons8-thick_long_left_arrow.png"))); // NOI18N
        ...
        Back.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons8-thick_long_left_arrow copy.png"))); // NOI18N
...
if(A_star.isSelected()){
  ...
  try {
    ...
    private void save_startActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save_startActionPerformed
       ...
       if(Default.isSelected())Next.setVisible(true);
       ...
       int [] [] ma=stac.pop();
        System.out.println("Move "+count );
         for (int i = 0; i < 3; i++) {
           ...
           System.out.println("*****************************************");
    System.out.println("tested node");
    while(!testedNode.empty()){
         System.out.println("Move "+count2 );
        int [] [] ma=testedNode.pop();
           for (int i = 0; i < 3; i++) {
             for (int j = 0; j < 3; j++) {
                 System.out.print(ma[i][j]);
             }
